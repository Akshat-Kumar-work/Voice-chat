...
export function  useWebRTC (roomId , user){
  ...
  //in this all remote connections info will be added every info regarding remote connections
...
console.log("connections ",connections.current)
    ...
    useEffect( ()=>{
      ...
      const setMute = (mute,userId)=>{
        //getting index of user from list whom we want to mute
